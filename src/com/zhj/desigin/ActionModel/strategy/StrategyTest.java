...
public class StrategyTest {
    ...
    public static void test() {
        ...
        System.out.println("我是普通会员，我不打折，价格为：" + shop.getPrice(price));

        shop.setStrategy(whiteGoldMember);
        System.out.println("我是白金会员，我打9折，价格为：" + shop.getPrice(price));

        shop.setStrategy(yellowGoldMember);
        System.out.println("我是黄金会员，我打8折，价格为：" + shop.getPrice(price));
